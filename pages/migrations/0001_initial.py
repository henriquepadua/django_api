    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='pages.author')),
                ('genre', models.ManyToManyField(help_text='Select a genre for this book', to='pages.genre')),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
            fields=[
                ...
                ('book', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='pages.book')),
            ],
            options={
                'ordering': ['due_back'],
            },
